...
INSERT OR IGNORE INTO Branch (id, clinicId, name, address, phone, isActive) VALUES ('branch-smile-expert-isb','clinic-smile-expert-001','Islamabad Aesthetics & General Clinic','F-7 Markaz, Islamabad, Pakistan','+92 51 111 764 533',1);
INSERT OR IGNORE INTO Staff (id,clinicId,branchId,name,role,designation,specialty,phone,email,avatar,avatarColor,qualifications,experience,bio,workingDays,workingHours,status,rating) VALUES
('s101','clinic-smile-expert-001','branch-smile-expert-main','Dr. Zara Ahmed','General Physician','Family Medicine Consultant','general','+92 300 5551001','zara@thesmileexpert.com','ZA','#0f766e','MBBS, FCPS Family Medicine','10 years','General physician focused on preventive care, family medicine, and clear treatment plans.','Mon,Tue,Wed,Thu,Fri,Sat','10:00-18:00','active',4.9),
('s102','clinic-smile-expert-001','branch-smile-expert-isb','Dr. Mahnoor Ali','Aesthetic Physician','Skin & Laser Specialist','aesthetics','+92 300 5551002','mahnoor@thesmileexpert.com','MA','#be3455','MBBS, Diploma Dermatology, Aesthetic Medicine Certification','8 years','Aesthetic physician offering evidence-led skin, laser, and rejuvenation treatments.','Mon,Tue,Wed,Thu,Fri,Sat','11:00-19:00','active',4.9),
('s103','clinic-smile-expert-001','branch-smile-expert-main','Dr. Hira Salman','Dermatologist','Consultant Dermatologist','aesthetics','+92 300 5551003','hira@thesmileexpert.com','HS','#7c3aed','MBBS, FCPS Dermatology','12 years','Consultant dermatologist for acne, pigmentation, hair loss, and medical skin concerns.','Mon,Wed,Fri,Sat','12:00-18:00','active',4.8);
INSERT OR IGNORE INTO Service (id,clinicId,name,specialty,category,price,duration,description,popular,isActive) VALUES
...
INSERT OR IGNORE INTO GalleryItem (id,clientId,type,imageUrl,service,notes,isPrivate) VALUES
...
INSERT OR IGNORE INTO Feedback (id,clinicId,clientId,appointmentId,staffRating,serviceRating,overallRating,comment,wouldRecommend,isPublic,staffId) VALUES
