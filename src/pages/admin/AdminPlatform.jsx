  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-start justify-between gap-4 flex-wrap">
        ...
        <button onClick={save} disabled={saving} className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-orange-600 hover:bg-orange-700 disabled:opacity-50 text-white text-sm font-bold shadow-sm">
      ...
      <section className="rounded-2xl border border-gray-200/70 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] p-5">
        <div className="flex items-center gap-2 mb-1"><Bot className="w-4 h-4 text-orange-500" /><h2 className="text-sm font-black text-gray-900 dark:text-white">Shared AI (all clinics)</h2></div>
      ...
      {/* Marketing branding */}
      <section className="rounded-2xl border border-gray-200/70 dark:border-white/10 bg-white/80 dark:bg-white/[0.04] p-5">
        <div className="flex items-center gap-2 mb-1"><Palette className="w-4 h-4 text-orange-500" /><h2 className="text-sm font-black text-gray-900 dark:text-white">Marketing website branding</h2></div>
