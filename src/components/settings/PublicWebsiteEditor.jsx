...
const sectionLabels = { offers: 'Offers', services: 'Services', doctors: 'Doctors', gallery: 'Gallery', testimonials: 'Testimonials', about: 'About', faq: 'FAQs', map: 'Google Map', booking: 'Booking Form' };
