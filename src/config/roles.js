...
export const ROLE_ACCESS = {
  ...
  doctor: ['dashboard', 'clinical', 'appointments', 'clients', 'gallery', 'feedback', 'inventory'],
  therapist: ['dashboard', 'clinical', 'appointments', 'clients', 'gallery', 'feedback', 'inventory'],
  accountant: ['dashboard', 'clients', 'financials', 'packages', 'invoices', 'reports'],
  receptionist: ['dashboard', 'reception', 'appointments', 'clients', 'invoices', 'packages', 'whatsapp', 'reports', 'support'],
